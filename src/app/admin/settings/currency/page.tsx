...
export default function CurrencySettingsPage() {
  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-black text-admin-text">تنظیمات ارز و قیمت‌گذاری</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Form (7 cols) */}
        <div className="lg:col-span-7 bg-white border border-admin-borderLight rounded-xl p-6 shadow-xs">
          <h3 className="font-bold text-sm text-admin-text mb-6 flex items-center gap-2">
          ...
          <form onSubmit={handleSave} className="space-y-6 text-xs">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-admin-bg border border-admin-borderLight focus:border-admin-primary rounded-lg py-3 px-4 text-sm font-mono font-bold outline-none"
                  required
                />
              ...
              <div className="mt-2 flex items-center gap-2 text-xs text-teal-800 bg-teal-50 p-2.5 rounded-lg border border-teal-200">
            ...
            <div>
              <label className="block font-bold text-neutral-800 mb-1.5 flex items-center justify-between">
            ...
            {toast && (
              <div className="p-3.5 bg-emerald-50 text-emerald-800 rounded-lg text-xs flex items-center gap-2 border border-emerald-200 animate-fadeIn">
        ...
        <div className="lg:col-span-5 bg-white border border-admin-borderLight rounded-xl p-6 shadow-xs space-y-4">
          ...
          <div className="space-y-3 pt-2">
            {sampleUsdValues.map((val) => {
              ...
              const formatted = new Intl.NumberFormat("fa-IR").format(finalToman);

              return (
                <div
                  key={val}
                  className="bg-admin-bg p-3.5 rounded-lg border border-admin-borderLight flex items-center justify-between"
                >
                  <div>
                    ...
                    <span className="text-[10px] text-neutral-400 block mt-0.5">
                      خرید خام: {new Intl.NumberFormat("fa-IR").format(Math.round(baseToman))} تومان
                    </span>
                  </div>

                  <div className="text-left">
                    <span className="font-black text-sm text-admin-primary">
                      {formatted}
                    </span>
          ...
          <div className="mt-4 p-3 bg-neutral-50 rounded-lg text-[11px] text-neutral-500">

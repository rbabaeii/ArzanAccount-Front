    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="bg-white p-5 rounded-2xl border border-admin-borderLight shadow-card">
          <span className="text-xs font-bold text-admin-textMuted">مجموع فروش ناخالص</span>
          <div className="mt-2 text-2xl font-black text-admin-text font-mono">
            {new Intl.NumberFormat("fa-IR").format(totalRevenueToman)}
          </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-admin-borderLight shadow-card">
          <span className="text-xs font-bold text-admin-textMuted">سود خالص تخمینی</span>
          <div className="mt-2 text-2xl font-black text-emerald-600 font-mono">
            {new Intl.NumberFormat("fa-IR").format(netProfitToman)}
          </div>
          <span className="text-xs text-neutral-400">تومان</span>
        ...
        <div className="bg-white p-5 rounded-2xl border border-admin-borderLight shadow-card">
          <span className="text-xs font-bold text-admin-textMuted">میانگین مبلغ سبد خرید</span>
          <div className="mt-2 text-2xl font-black text-brand-primary font-mono">
            {new Intl.NumberFormat("fa-IR").format(averageOrderValueToman)}
          </div>
          <span className="text-xs text-neutral-400">تومان</span>
        ...
        <div className="bg-white p-5 rounded-2xl border border-admin-borderLight shadow-card">
          <span className="text-xs font-bold text-admin-textMuted">هزینه خرید ارزی عمده</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="space-y-4 pt-2 text-xs">
            <div>
              <div className="flex justify-between font-bold mb-1">
                <span className="text-admin-text">هوش مصنوعی (ChatGPT & Gemini)</span>
            ...
            <div>
              <div className="flex justify-between font-bold mb-1">
                <span className="text-admin-text">شبکه‌های اجتماعی و SMM</span>
            ...
            <div>
              <div className="flex justify-between font-bold mb-1">
                <span className="text-admin-text">فیلم و سریال (YouTube & Netflix)</span>
            ...
            <div>
              <div className="flex justify-between font-bold mb-1">
                <span className="text-admin-text">موسیقی و ابزارهای کاربردی</span>
        ...
        <div className="lg:col-span-7 bg-white border border-admin-borderLight rounded-2xl p-6 shadow-card space-y-4">
          ...
          <div className="divide-y divide-admin-borderLight text-xs">
